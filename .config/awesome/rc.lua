...
awful.screen.connect_for_each_screen(function(s)
	...
	-- Apply gap settings to each tag
...
--launch programs
	...
	awful.key({ modkey }, "g", function() awful.spawn("ghostty") end,
		{ description = "launch Ghostty", group = "launcher" }),
	awful.key({}, "Print", function() awful.spawn("flameshot gui") end,
		{ description = "launch flameshot", group = "launcher" }),
	awful.key({ modkey }, "F12",
		function() awful.spawn("sh -c '~/.config/rofi/settings-launcher.sh'") end,
		{ description = "Open Settings Launcher", group = "custom" }),
...
-- DISABLED because titlebars look ugly
